...
<body class="ubuntu-regular text-sm min-h-svh bg-slate-200 flex items-center justify-center">
  <form action="../controllers/auth.php" method="post" class="w-1/2 flex bg-white shadow p-5 rounded-xl">
    ...
    <div class="w-full h-auto flex flex-col gap-3">
      ...
      <span class="w-full h-fit flex gap-2 justify-center mt-2">
        <button type="submit" class="w-fit h-fit px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white font-medium cursor-pointer">Login</button>
      </span>
      <span class="w-full flex gap-1 justify-center">
        <p class="w-fit text-gray-500">Don't have an account?</p>
        <a href="register.php" class="w-fit text-black hover:text-blue-500 hover:underline">Register</a>
      </span>
    </div>
    <div class="w-full h-auto flex items-center">
      <img src="../resources/images/auth.svg" alt="todo" class="">
    </div>
